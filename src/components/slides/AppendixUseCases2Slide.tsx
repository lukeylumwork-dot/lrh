...
const defaultBlocks: Block[] = [
  { id: "eyebrow", kind: "eyebrow", text: "Appendix · Use Cases (cont.)", x: PAD_X, y: 6, w: 50, h: 3 },
  { id: "title", kind: "title", text: "Use Cases — Buyside & Infra.", x: PAD_X, y: 11, w: 80, h: 10 },
...
export function AppendixUseCases2Slide() {
  const regions = {
    ...
    footer: <SlideFooter page={17} />,
  };
  return <GenericSlide slideId="appendixUseCases2" defaultBlocks={defaultBlocks} regions={regions} />;
}
